<?php
  ...
  define("DEBUG",false);
    ...
    $url = "https://nXX.epom.com/rest-api/placements/update/video.do";
    ...
    $post_data = array(
        ...
        "username" => $username,
        "zoneId" => 308,
        "type" => "VIDEO_PLACEMENT",
        "name" => "Test_Video_placement",
        "description" => "Test create placement",
        "videoFormats" => "MID_ROLL",
